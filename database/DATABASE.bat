@echo off
@echo Starting Alicebot.Net 4.0 Beta Database Manager ...
...
java -classpath %CLASSPATH% -Xms64m -Xmx64m -Djava.library.path=./bin org.alicebot.server.sql.util.DatabaseManager
