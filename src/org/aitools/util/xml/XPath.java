...
/**
 * Utility methods for XPath. (Just thin convenience wrappers around JDOM's XPath stuff.)
 * 
...
public class XPath {
  ...
  /**
   * Creates a new XPath object with the given path, with the given namespace URI and prefix mappings.
   * 
   * @param path
   * @param namespaceURI a namespace URI
   * @param prefix a prefix associated with the namespace URI
