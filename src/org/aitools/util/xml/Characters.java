...
public class Characters {
   ...
   * </p>
   * <p>
   * This will handle entities in the form <code>&amp;#<i>xxxx</i>;</code> (decimal character code, where <i>xxxx </i>
   * is a valid character code), or <code>&amp;#x<i>xxxx</i></code> (hexadecimal character code, where <i>xxxx </i> is a
  ...
  public static String escapeXMLChars(String input) {
    ...
    return input.replace(AMPERSAND, XML_AMPERSAND).replace(LESS_THAN, XML_LESS_THAN)
        .replace(GREATER_THAN, XML_GREATER_THAN).replace(QUOTE, XML_QUOTE).replace(APOSTROPHE, XML_APOSTROPHE);
  }
  ...
  public static String unescapeXMLChars(String input) {
    return input.replaceAll(XML_LESS_THAN_REGEX, LESS_THAN).replaceAll(XML_GREATER_THAN_REGEX, GREATER_THAN)
        .replaceAll(XML_AMPERSAND_REGEX, AMPERSAND).replaceAll(XML_QUOTE_REGEX, QUOTE)
        .replaceAll(XML_APOSTROPHE_REGEX, APOSTROPHE);
  }
}
