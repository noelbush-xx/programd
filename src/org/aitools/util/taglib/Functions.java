...
/**
 * Provides access to aitools-utils functions via JSP tags or functions.
 * 
...
public class Functions {
  ...
  /**
   * Unescapes a given string by converting XML entities to their character equivalents.
   * 
   * @param string
