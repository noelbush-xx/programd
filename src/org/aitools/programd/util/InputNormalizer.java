...
/**
 * <code>InputNormalizer</code> replaces <code>Substituter</code> as the utility class for performing various stages of
 * <a href="http://aitools.org/aiml/TR/2001/WD-aiml/#section-input-normalization">input normalization </a>.
 * Substitutions of other types are now handled independently by their respective processors.
 * 
 */
public class InputNormalizer {
  ...
  /**
   * <p>
   * Performs <a href="http://aitools.org/aiml/TR/2001/WD-aiml/#section-pattern-fitting-normalizations">pattern-fitting
   * </a> normalization on an input.
   * </p>
   * <p>
   * This is best used to produce a caseless representation of the effective match string when presenting match results
   * to a user; however, if used when actually performing the match it will result in the case of wildcard-captured
   * values being lost. Some amendment of the specification is probably in order.
   * </p>
   * 
   ...
   * href="http://aitools.org/aiml/TR/2001/WD-aiml/#section-pattern-fitting-normalizations">pattern-fitting </a>
   * normalization on an input -- partial because it does <i>not </i> convert letters to uppercase.
   * </p>
   * <p>
   * This is used when sending patterns to the Graphmaster so that wildcard contents can be captured and case retained.
  ...
  public static String patternFitIgnoreCase(String input) {
    return Text.normalizeString(ILLEGAL_CHARACTERS_IGNORE_CASE.matcher(Characters.removeMarkup(input)).replaceAll(" "))
        .trim();
  }

  /**
   * Splits an input into sentences, as defined by the <code>sentenceSplitters</code>.
   * 
