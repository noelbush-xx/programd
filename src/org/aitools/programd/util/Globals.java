...
public class Globals
{
    ...
    /** Whether to log gossip to XML. */
    private static boolean gossipToXML;
    ...
    public static void loadProperties()
    {
        ...
        useWatcher =
            Boolean
                .valueOf(properties.getProperty("programd.watcher", "false"))
                .booleanValue();
        ...
        haveAHeart =
            Boolean
                .valueOf(
                    properties.getProperty("programd.heart.enabled", "false"))
                .booleanValue();

        // Whether to use the shell; default true.
        useShell =
            Boolean
                .valueOf(properties.getProperty("programd.shell", "true"))
                .booleanValue();

        // Whether to show the console; default true.
        showConsole =
            Boolean
                .valueOf(properties.getProperty("programd.console", "true"))
                .booleanValue();
        ...
        useTargeting =
            Boolean
                .valueOf(properties.getProperty("programd.targeting", "true"))
                .booleanValue();

        // Whether to log gossip to XML; default true.
        gossipToXML =
            Boolean
                .valueOf(
                    properties.getProperty(
                        "programd.logging.to-xml.gossip",
                        "true"))
                .booleanValue();
        ...
        systemPrefix =
            properties.getProperty("programd.interpreter.system.prefix", "");
        ...
        supportDeprecatedTags =
            Boolean
                .valueOf(
                    properties.getProperty(
                        "programd.deprecated-tags-support",
                        "false"))
                .booleanValue();
        ...
        nonAIMLRequireNamespaceQualification =
            Boolean
                .valueOf(
                    properties.getProperty(
                        "programd.non-aiml-require-namespace-qualifiers",
                        "false"))
                .booleanValue();
        ...
        predicateValueCacheMax =
            predicateValueCacheMax > 0 ? predicateValueCacheMax : 5000;

        // The fully-qualified name of the JavaScript interpreter.
        javaScriptInterpreter =
            properties.getProperty("programd.interpreter.javascript", "");
        ...
        try
        {
            categoryLoadNotifyInterval =
                Integer.parseInt(
                    properties.getProperty(
                        "programd.console.category-load-notify-interval",
                        "1000"));
        }
        catch (NumberFormatException e)
        {
        ...
        categoryLoadNotifyInterval =
            categoryLoadNotifyInterval > 0 ? categoryLoadNotifyInterval : 1000;
        ...
        try
        {
            rootPath =
                new File(
                    properties.getProperty("programd.root-directory", ".."))
                    .getCanonicalPath()
                    + File.separator;
        }
        catch (IOException e)
        {
            String error =
                "Root directory cannot be found (check server properties).";
        ...
        {
            String error =
                "Startup file cannot be found (check server properties).";
            Log.log(error, Log.STARTUP);
            throw new UserError(error);
        }
        isLoaded = true;
    ...
    /**
     *  Returns whether the {@link org.aitools.programd.multiplexor.loader.AIMLWatcher AIML Watcher} is active.
     *
     *  @return whether the {@link org.aitools.programd.multiplexor.loader.AIMLWatcher AIML Watcher} is active
     */
     ...
     *
     *  @return whether to log gossip to XML
     */
