...
/**
 * <p>
 * <code>Globals</code> gives access to the server properties used when
 * starting the bot.
 * </p>
 * 
...
public class Globals
{
    ...
    /**
     * The interval at which the user should be notified of how many targets
     * have been loaded.
     */
    ...
    public static void loadProperties()
    {
        ...
        showMatchTrace = showConsole ? Boolean.valueOf(properties.getProperty("programd.console.match-trace", "true"))
                .booleanValue() : false;
        ...
        gossipToXML = Boolean.valueOf(properties.getProperty("programd.logging.to-xml.gossip", "true")).booleanValue();
        ...
        // Default for predicates with no defined values; default is empty
        // string.
        predicateEmptyDefault = properties.getProperty("programd.emptydefault", "");

        // Input to match if an infinite loop is found; default is
        // &quot;INFINITE LOOP&quot;.
        infiniteLoopInput = InputNormalizer.patternFitIgnoreCase(properties.getProperty("programd.infinite-loop-input",
                "INFINITE LOOP"));
        ...
        jsAccessAllowed = Boolean.valueOf(properties.getProperty("programd.javascript-allowed", "false"))
                .booleanValue();
        ...
        supportDeprecatedTags = Boolean.valueOf(properties.getProperty("programd.deprecated-tags-support", "false"))
                .booleanValue();

        // Whether to warn about deprecated tags; default false.
        warnAboutDeprecatedTags = supportDeprecatedTags ? Boolean.valueOf(
                properties.getProperty("programd.deprecated-tags-warn", "false")).booleanValue() : false;

        // Whether to require namespace qualifiers on non-AIML tags; default
        // false.
        nonAIMLRequireNamespaceQualification = Boolean.valueOf(
                properties.getProperty("programd.non-aiml-require-namespace-qualifiers", "false")).booleanValue();
     ...
     * any).
     * 
     * @return the fully-qualified class name of the JavaScript interpteter (if
     *         any)
     */
