...
public class TargetWriter extends Targeting
{
     ...
     *            the target to write
     * @param spec
     *            the XML resource spec for the target file
     */
    public static void write(Target target, XMLResourceSpec spec)
    {
        if (target != null)
        {
            ...
            XMLWriter.write(INDENT + TARGET_START + LINE_SEPARATOR + INDENT + INDENT + INPUT_START + LINE_SEPARATOR
                    ...
                    + INDENT + INDENT + INPUT_END + LINE_SEPARATOR + INDENT + INDENT + MATCH_START + LINE_SEPARATOR
                    + INDENT + INDENT + INDENT + PATTERN_START + target.getMatchPattern() + PATTERN_END
                    + LINE_SEPARATOR + INDENT + INDENT + INDENT + THAT_START + target.getMatchThat() + THAT_END
                    + LINE_SEPARATOR + INDENT + INDENT + INDENT + TOPIC_START + target.getMatchTopic() + TOPIC_END
                    + LINE_SEPARATOR + INDENT + INDENT + INDENT + TEMPLATE_START + target.getMatchTemplate()
