...
public class ConsoleSettings extends Settings
{
    ...
    */
    ...
    /**
     * @param showMethodNamesForErrorsToSet   the value to which to set showMethodNamesForErrors
     */
