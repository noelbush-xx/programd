...
/**
 * A <code>Processor</code> is responsible for processing an element. Subclasses of this base class need only implement
 * the {@link #process} method and set <code>label</code> to the appropriate string.
 * 
