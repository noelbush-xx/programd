...
public class ListenerRegistry extends ClassRegistry
{
    ...
    private static final String[] PROCESSOR_LIST =
        {
            "org.alicebot.agent.listener.AIMListener",
            "org.alicebot.agent.listener.ICQListener",
            "org.alicebot.agent.listener.IRCListener" };

    /** The fully-qualified name of {@link Listener}. */
    private static final String PROCESSOR_BASE_CLASS_NAME =
        "org.alicebot.agent.listener.Listener";
