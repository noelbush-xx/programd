...
public class AliceICQ implements Runnable, AliceChatListener
{
    ...
    {
        if (properties.getProperty("programd.listeners.icq.number") != null)
        {
            AliceICQ icq = new AliceICQ(properties.getProperty("programd.listeners.icq.number"), 
                                        properties.getProperty("programd.listeners.icq.password"));
        }
    }
