...
public class MessagePrinter
{
    ...
    private static final String FILE_WRITER_ERROR = "Error writing to file: ";
     ...
     */
    static void println(String message, String typeFlag, PrintStream out, int destination)
    {
        if (midLine)
        {
            out.println();
     ...
     *  @param destination  destination flag (for choosing format)
     */
    static void print(String message, String typeFlag, PrintStream out, int destination)
    {
        if (midLine)
        {
            out.println();
     ...
     *  @param destination  destination flag (for choosing format)
     */
    static void println(String message, String typeFlag, FileWriter out, int destination)
    {
        try
        {
        ...
        {
            Trace.userfail(FILE_WRITER_ERROR);
        }
    }
