 ...
 * Please note there is some redundancy with the AIMLTag.java
 * class still used by the AIML loader (AIMLReader.java and others)
 * both classes should be consolidated upon a convergence to a
