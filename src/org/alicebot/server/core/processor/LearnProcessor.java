...
/*
    ...
    - removed needless call to duplicate load method in Toolkit
*/
...
public class LearnProcessor extends AIMLProcessor
{
    ...
    /**
     *  Attempts to load an AIML file whose location is
    ...
    public String process(int level, String userid, XMLNode tag, AIMLParser parser) throws AIMLProcessorException
    {
        ...
        {
            Graphmaster.load(parser.evaluate(level++, userid, tag.XMLChild).trim());
            return EMPTY_STRING;
        }
        else
        {
