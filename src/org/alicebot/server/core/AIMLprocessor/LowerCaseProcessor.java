...
/**
 LowerCaseProcessor is the processor responsible to evaluate a LOWERCASE
 tag, the tags beneath it are evaluated and the result turned into
 lowercase.
 @version 4.1.1
 @author  Thomas Ringate/Pedro Colla
*/
public class LowerCaseProcessor implements AIMLProcessor, Serializable {
