 ...
 */
  public void init() {
    ...
    String driver=p.getProperty("driver","org.alicebot.server.sql.jdbcDriver");
    String url=p.getProperty("url","jdbc:alicebot:");
    String database=p.getProperty("database","test");
    String user=p.getProperty("user","dany");
    ...
    try {
      ...
      new org.alicebot.server.sql.jdbcDriver();
