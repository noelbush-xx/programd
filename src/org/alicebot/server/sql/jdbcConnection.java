 ...
 * The url for an In-Memory database is <code>jdbc:alicebot:.</code>
 * The url for a standalone database is jdbc:alicebot:name
 * where name is the filename of the database, including path. For example:
 * <code>jdbc:alicebot:test</code> will connect to a database called
