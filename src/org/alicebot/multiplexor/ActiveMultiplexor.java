...
public class ActiveMultiplexor
{
    ...
    private static final ActiveMultiplexor myself =
        new ActiveMultiplexor(
            Globals.getProperty(
                "programd.multiplexor",
                "org.alicebot.multiplexor.FlatFileMultiplexor"));
    ...
    private ActiveMultiplexor(String className)
    {
        ...
        {
            throw new DeveloperError("Specified multiplexor class (\"" + className + "\") or its nullary constructor was not available.");
        }
        ...
        {
            throw new DeveloperError("Permission denied to create a new instance of specified multiplexor class (\"" + className + "\").");
        }
    }
