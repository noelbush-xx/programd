...
public class Substituter
{
     ...
     */
    public static String applySubstitutions(
        ...
        String input)
    {
        ...
        while (substitutions.hasNext())
        {
            ...
            while (untouchedIterator.hasNext())
            {
                ...
                int startIndex =
                    untouchedTest.toUpperCase().indexOf(find.toUpperCase());
